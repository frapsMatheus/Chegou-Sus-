 ...
 */
public class PreferidosFragment extends Fragment implements DBObserver {
    ...
    private void updateView() {
        if (DBUser.shared().lastKnowLocation != null) {
            ...
            LinkedHashMap<PostoDeSaude, Double> postosComDistancia =
                    DBMain.shared().getPostosPreferidosComDistancia(DBUser.shared().lastKnowLocation, postos);
